                        ...
                        with hcl.for_(0, V_init.shape[3], name="l") as l:
                            with hcl.for_(0, V_init.shape[4], name="m") as m:
                                with hcl.for_(0, V_init.shape[5], name="n") as n:
                                    ...
                                    dx_LL5[0] = hcl_math.abs(dx_LL5[0])
                                    dx_LL6[0] = hcl_math.abs(dx_LL6[0])
                                    ...
                                    dx_UL5[0] = hcl_math.abs(dx_UL5[0])
                                    dx_UL6[0] = hcl_math.abs(dx_UL6[0])

                                    # Set maximum alphas
                                    alpha1[0] = hcl_math.max(dx_UL1[0], dx_LL1[0])
                                    alpha2[0] = hcl_math.max(dx_UL2[0], dx_LL2[0])
                                    alpha3[0] = hcl_math.max(dx_UL3[0], dx_LL3[0])
                                    alpha4[0] = hcl_math.max(dx_UL4[0], dx_LL4[0])
                                    alpha5[0] = hcl_math.max(dx_UL5[0], dx_LL5[0])
                                    alpha6[0] = hcl_math.max(dx_UL6[0], dx_LL6[0])
                                    ...
                                    dx_LU5[0] = hcl_math.abs(dx_LU5[0])
                                    dx_LU6[0] = hcl_math.abs(dx_LU6[0])

                                    alpha1[0] = hcl_math.max(alpha1[0], dx_LU1[0])
                                    alpha2[0] = hcl_math.max(alpha2[0], dx_LU2[0])
                                    alpha3[0] = hcl_math.max(alpha3[0], dx_LU3[0])
                                    alpha4[0] = hcl_math.max(alpha4[0], dx_LU4[0])
                                    alpha5[0] = hcl_math.max(alpha5[0], dx_LU5[0])
                                    alpha6[0] = hcl_math.max(alpha6[0], dx_LU6[0])
                                    ...
                                    dx_UU5[0] = hcl_math.abs(dx_UU5[0])
                                    dx_UU6[0] = hcl_math.abs(dx_UU6[0])
                                    ...
                                    alpha5[0] = hcl_math.max(alpha5[0], dx_UU5[0])
                                    alpha6[0] = hcl_math.max(alpha6[0], dx_UU6[0])
